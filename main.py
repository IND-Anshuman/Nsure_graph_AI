    ...
    *,
    ...
    try:
        rr = llm_rerank_candidates(
            ...
            model_name=str(qa_opts.get("rerank_model") or os.getenv("GEMINI_MODEL") or "gemini-2.0-flash"),
    ...
    try:
        result = llm_synthesize_answer(
            ...
            graph=graph,
            query_type=qtype,
            model_name=str(qa_opts.get("synthesis_model") or os.getenv("GEMINI_MODEL") or "gemini-2.0-flash"),
